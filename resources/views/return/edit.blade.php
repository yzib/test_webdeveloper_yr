...
@section('ContentForm')
	...
	@foreach($return as $return)
		...
		<tr>
			...
			<input type="text" id="car_idx" name="car_idx" size="10" maxlength="10" style="display: none;" value="{{ $return->car_idx }}" /></td>
			<td style="padding-left: 5px;">No. Pol. </td> 
			<td style="padding: 3px;"><input type="text" id="car_num" name="car_num" onfocus="cariCar('Pilih Kontrak Sewa','Event');" value="{{ $return->car_num }}" /></td>
		</tr>
		<tr>
			<td style="padding-left: 5px;">Model</td> 
			<td style="padding: 3px;"><input type="text" id="model" name="model" onchange="" value="{{ $return->model }}"" disabled /></td>
			<td style=" padding-right:5px;padding-left: 25px;">Tgl. Mulai</td>
			<td style="padding: 3px;"><input type="text" id="date_start" name="date_start" value="{{ $return->start_date_return }}"  /></td>	
		</tr>
		<tr>
			<td style="padding-left: 5px;">Merk</td> 
			<td style="padding: 3px;"><input type="text" id="merk" name="merk" onchange="" value="{{ $return->merk }}" disabled /></td>
			<td style="padding-left: 25px;">Tgl. Sampai (Perjanjian) </td>
			<td style="padding: 3px;"><input type="text" id="date_end" name="date_end" onchange="" value="{{ $return->date_end }}" disabled />
			<input type="text" id="loan_id" name="loan_id" size="10" maxlength="10" value="{{ $return->loan_id }}" style="display:none;" /></td>		
		</tr>
		<tr>		
			<td style="padding-right:5px;" colspan=3></td> 
			<td style="padding: 3px; padding-top: 10px;">Jumlah Hari <input type="text" id="count_date" name="count_date" value="{{ $return->count_date }}" disabled /></td> 	
		</tr>
		<tr>
			<td style="padding-right:5px;" colspan=3></td> 
			<td style="padding: 3px;" align="right">Harga /hari <input type="text" id="price_done" name="price_done" value="{{ $return->price_done }}"  /></td> 	
		</tr>		
		<tr>
		...
		<tr>
			...
			<td style="padding: 3px;" align="right" ><input type="date" id="date_return" name="date_return" onchange="count_over()" value="{{ $return->date_return }}" /></td> 	
			<td style="padding: 3px;" align="right" colspan=2>Hari Sewa <input type="text" id="over_c_date" name="over_c_date" onchange=""
			value="{{ $return->over_c_date }}"  /></td> 	
		</tr>
		<tr>
			<td style="padding-right:5px;" colspan=2></td> 
			<td style="padding: 3px;" align="right" ></td> 	
			<td style="padding: 3px;padding-top:15px;" align="right" colspan=2>Total Sewa <input type="text" id="over_price" name="over_price" onchange=""
			value="{{ $return->over_price }}"  /></td> 	
		</tr>
