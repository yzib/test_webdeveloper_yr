...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-warning">
    <div class="container-fluid" width=100%>
		...
		<table width=100%>
		<th><td>No</td><td>Peminjam</td><td>Plat NO.</td><td>Merk</td><td>Tgl. Kembali</td><td>Tgl Mulai</td><td>Lama</td><td>Harga Total</td></th>
		@foreach($posts as $post)
		<tr>
		<td>No</td><td>Peminjam</td><td>Plat NO.</td><td>Merk</td><td>Tgl. Kembali</td><td>Tgl Mulai</td><td>Lama</td><td>Harga Total</td>
		</tr>
		@endforeach
		</table>
    </div>
